  ...
  return (
    <div className="bg-white">
      <div className="lg:hidden flex justify-between items-center">
        <div className="justify-left font-bold text-black">Tech Trend Emporium</div>
        <Hamburger toggled={isOpen} size={20} toggle={setOpen} rounded color="#000" />
      </div>
      {isOpen && (
        <div className="fixed left-0 right-0 top-[7rem] bg-neutral-950 border-b border-b-white/20">
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <button className="text-white py-4">Login</button>
